...
public class CarteiraController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<CarteiraDTO> updateCarteira(@PathVariable Long id, @RequestBody CarteiraDTO carteiraDTO) {
        CarteiraDTO updatedCarteira = carteiraService.update(id, carteiraDTO);
        if (updatedCarteira != null) {
